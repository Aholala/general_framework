/**
 * @file module_nrf24l01_ace_link.c
...
const uint8_t module_nrf24l01_ace_link_address[MODULE_NRF24L01_ACE_LINK_ADDRESS_SIZE] = {'A', 'C',
                                                                                         'E'};

static module_nrf24l01_ace_link_status_t
module_nrf24l01_ace_link_map_radio_status(module_nrf24l01_status_t status)
{
    switch (status)
    {
    case MODULE_NRF24L01_STATUS_OK:
        return MODULE_NRF24L01_ACE_LINK_STATUS_OK;
    case MODULE_NRF24L01_STATUS_NO_DATA:
        return MODULE_NRF24L01_ACE_LINK_STATUS_NO_DATA;
    case MODULE_NRF24L01_STATUS_BUSY:
        return MODULE_NRF24L01_ACE_LINK_STATUS_BUSY;
    case MODULE_NRF24L01_STATUS_MAXIMUM_RETRANSMIT:
        return MODULE_NRF24L01_ACE_LINK_STATUS_MAXIMUM_RETRANSMIT;
    case MODULE_NRF24L01_STATUS_INVALID_ARGUMENT:
        return MODULE_NRF24L01_ACE_LINK_STATUS_INVALID_ARGUMENT;
    case MODULE_NRF24L01_STATUS_NOT_INITIALIZED:
        return MODULE_NRF24L01_ACE_LINK_STATUS_NOT_INITIALIZED;
    case MODULE_NRF24L01_STATUS_NOT_STARTED:
        return MODULE_NRF24L01_ACE_LINK_STATUS_NOT_STARTED;
    case MODULE_NRF24L01_STATUS_TRANSPORT_ERROR:
    case MODULE_NRF24L01_STATUS_DEVICE_NOT_FOUND:
    default:
        return MODULE_NRF24L01_ACE_LINK_STATUS_TRANSPORT_ERROR;
    }
}

static uint16_t module_nrf24l01_ace_link_crc16(const uint8_t *data, size_t data_size)
{
    uint32_t result = 0U;
                                                                ...
                                                                module_nrf24l01_t *radio)
{
    if ((me == NULL) || (radio == NULL) || !module_device_is_initialized(&radio->super) ||
        (radio->payload_size < MODULE_NRF24L01_ACE_LINK_OVERHEAD_SIZE))
    {
        return MODULE_NRF24L01_ACE_LINK_STATUS_INVALID_ARGUMENT;
    }

    *me = (module_nrf24l01_ace_link_t){
        .radio = radio,
                                                                ...
                                                                size_t data_size)
{
    ...
    if ((me->radio->payload_size < MODULE_NRF24L01_ACE_LINK_OVERHEAD_SIZE) ||
        (data_size > (size_t)(me->radio->payload_size - MODULE_NRF24L01_ACE_LINK_OVERHEAD_SIZE)))
    {
        return MODULE_NRF24L01_ACE_LINK_STATUS_INVALID_ARGUMENT;
    }

    radio_payload[0] = MODULE_NRF24L01_ACE_LINK_HEADER_FIRST;
    radio_payload[1] = MODULE_NRF24L01_ACE_LINK_HEADER_SECOND;
    ...
    checksum = module_nrf24l01_ace_link_crc16(radio_payload, 5U + data_size);
    ...
    return module_nrf24l01_ace_link_map_radio_status(radio_status);
}

module_nrf24l01_ace_link_status_t
module_nrf24l01_ace_link_receive(module_nrf24l01_ace_link_t *me,
                                 module_nrf24l01_ace_link_packet_t *packet, uint8_t *pipe_index)
{
    ...
    if ((radio_payload[0] != MODULE_NRF24L01_ACE_LINK_HEADER_FIRST) ||
        (radio_payload[1] != MODULE_NRF24L01_ACE_LINK_HEADER_SECOND) ||
        (radio_payload[4] >
         (uint8_t)(me->radio->payload_size - MODULE_NRF24L01_ACE_LINK_OVERHEAD_SIZE)))
    {
        return MODULE_NRF24L01_ACE_LINK_STATUS_INVALID_FRAME;
    }
    ...
    if (received_checksum != module_nrf24l01_ace_link_crc16(radio_payload, checksum_offset))
    {
        return MODULE_NRF24L01_ACE_LINK_STATUS_CHECKSUM_ERROR;
    }
