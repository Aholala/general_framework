 ...
 * @brief 大疆 M2006 电机（C610 电调）专用派生模块头文件
 * @version 1.0
 * @date 2026-07-28
...
extern "C"
{
    ...
    /**
     * @brief M2006 初始化配置
     * @note motor_identifier 为 1~8（M2006 支持完整的 1~8 个 ID）
     *       direction_sign 只能为 +1 或 -1
     *       M2006 默认减速比为 36.0F（可配置但本模块固定）
     */
    typedef struct
    {
     ...
     *       继承链：module_motor_t → module_dji_motor_t → module_m2006_t
     */
    struct module_m2006
    {
