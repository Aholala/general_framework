...
extern "C"
{
    ...
    typedef enum
    {
        MODULE_NRF24L01_LINK_STATUS_OK = 0,
        MODULE_NRF24L01_LINK_STATUS_NO_DATA,
        MODULE_NRF24L01_LINK_STATUS_BUSY,
        MODULE_NRF24L01_LINK_STATUS_MAXIMUM_RETRANSMIT,
        MODULE_NRF24L01_LINK_STATUS_INVALID_ARGUMENT,
        MODULE_NRF24L01_LINK_STATUS_NOT_INITIALIZED,
        MODULE_NRF24L01_LINK_STATUS_NOT_STARTED,
        MODULE_NRF24L01_LINK_STATUS_TRANSPORT_ERROR,
        MODULE_NRF24L01_LINK_STATUS_INVALID_FRAME,
        MODULE_NRF24L01_LINK_STATUS_CHECKSUM_ERROR
    ...
    typedef struct
    {
        ...
        uint8_t sequence;
        uint8_t data_size;
        uint8_t data[MODULE_NRF24L01_LINK_MAXIMUM_DATA_SIZE];
